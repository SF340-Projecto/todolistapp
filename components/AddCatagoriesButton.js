...
export default function AddCatagoriesButton() {
  ...
  const AddCategory = () => {
    setModalVisible(!isModalVisible);
    dispatch(addCategory(user_id, topic));
  };
  return (
    <SafeAreaView>
      <View>
      ...
      <Modal
        ...
        <View style={styles.bg_modal}>
          <View style={styles.paper_madal}>
            ...
            <Text style={styles.text_normal}>CATEGORY COLOR</Text>

            <View style={styles.style_flexColor}>
              <TouchableHighlight valueColor={'#ff0000'}>
                <View style={styles.color_red}></View>
              </TouchableHighlight>
              <View style={{paddingRight: 10}}></View>

              <TouchableHighlight valueColor={'#00bfff'}>
                <View style={styles.color_blue}></View>
              </TouchableHighlight>
              <View style={{paddingRight: 10}}></View>

              <TouchableHighlight valueColor={'#008000'}>
                <View style={styles.color_green}></View>
              </TouchableHighlight>
              <View style={{paddingRight: 10}}></View>

              <TouchableHighlight valueColor={'#ffff00'}>
                <View style={styles.color_yellow}></View>
              </TouchableHighlight>
              <View style={{paddingRight: 10}}></View>

              <TouchableHighlight valueColor={'#800080'}>
            ...
            <View>
              <View style={styles.style_flex}>
                ...
                <TouchableOpacity
                  ...
                  <Text style={styles.addButtonText} onPress={AddCategory}>
                    OK
                  </Text>
                </TouchableOpacity>
              </View>
